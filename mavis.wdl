...
workflow mavis {
  ...
  Map[String,String] mavis_modules_by_genome = { 
     "hg19": "mavis/2.2.6 mavis-config/1.2 hg19-mavis/2.2.6 hg19/p13", 
     "hg38" : "mavis/2.2.6 mavis-config/1.2 hg38v110-mavis/2.2.6 hg38/p12", 
     "hg38_noAlt" : "mavis/2.2.6 mavis-config/1.2 hg38v110-mavis/2.2.6 hg38-noalt/p12"
  }
  ...
  "hg38_noAlt_annotations": "$HG38V110_MAVIS_ROOT/ensembl_v110_hg38_annotations.json", 
  "hg38_noAlt_dvgAnnotations": "$HG38V110_MAVIS_ROOT/dgv_hg38_variants.tab",
  "hg38_noAlt_cytoband": "$HG38V110_MAVIS_ROOT/cytoBand.txt",
  "hg38_noAlt_masking": "$HG38V110_MAVIS_ROOT/hg38_masking.tab",
  "hg38_noAlt_referenceGenome": "$HG38_NOALT_ROOT/hg38_noAlt.fa",
  "hg38_noAlt_alignerReference": "$HG38V110_MAVIS_ROOT/hg38.2bit",
 }
