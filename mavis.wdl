...
workflow mavis {
  ...
  scatter(ct in setup.clusterTabs) {
    call submitSingle as validate {
      input: inFiles=ct, script=setup.submitValidate, outFileName="validation-passed.tab"
    }
    call submitSingle as annotate {
      input: inFiles=validate.outFile, script=setup.submitAnnotate, outFileName="annotations.tab"
    }
  }
...
task submitSingle {
  ...
  # edit and run a submit.sh script generated by Mavis, with a single file as input
